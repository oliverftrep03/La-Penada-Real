...
export default function LoginPage() {
    ...
    return (
        <div className="relative flex h-screen w-full flex-col items-center justify-center overflow-hidden bg-black text-white">
            ...
            <div className="z-10 flex flex-col items-center gap-8 p-6 text-center animate-in fade-in zoom-in duration-500">
                {/* Logo / Title */}
                ...
                <button
                    ...
                    className="group relative flex items-center gap-3 bg-white text-black px-8 py-4 rounded-full font-bold text-lg transition-all hover:scale-105 hover:shadow-[0_0_30px_rgba(255,255,255,0.3)] active:scale-95"
                >
